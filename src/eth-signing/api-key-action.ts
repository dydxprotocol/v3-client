...
export class SignApiKeyAction extends SignOffChainAction<ApiKeyAction> {

  constructor(
    web3: Web3,
    networkId: number,
  ) {
    super(web3, networkId, EIP712_API_KEY_ACTION_STRUCT);
  }

  public getHash(
    message: ApiKeyAction,
  ): string {
    const structHash: string | null = Web3.utils.soliditySha3(
      { t: 'bytes32', v: hashString(EIP712_API_KEY_ACTION_STRUCT_STRING) },
